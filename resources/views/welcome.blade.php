                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="#contact-us" class="menu-item">Daftar</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="left-text col-lg-6 col-md-12 col-sm-12 col-xs-12"
                        ...
                        <h1>PPDB <em>SMK WIKRAMA BOGOR</em></h1>
                        ...
                        <form id="contact" action="{{ route('store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <fieldset>
                                        <select class="form-control" value="number-guests" name="jenis_kelamin" id="number-guests">
                                ...
                                <div class="col-lg-6">
                                    <fieldset>
                                        <button type="submit" class="btn btn-success" id="form-submit" class="main-button-icon">Daftar</button>
                                    </fieldset>
                                </div>
                            </div>
                        </form>
